...
export const Testimonials = () => {
  ...
  const eyebrow = settings?.testimonials?.eyebrow || "Traveler Reviews";
  const heading = settings?.testimonials?.heading || "What Our Guests Say";
  const description =
  ...
  const reviews = settings?.testimonials?.reviews?.length
  ...
  const active = reviews[current] || reviews[0];
