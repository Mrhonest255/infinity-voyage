...
Address: Arusha, Tanzania`
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO 
        title="Privacy Policy - Infinity Voyage Tours & Safaris"
        description="Learn how we collect, use, and protect your personal information. Our privacy policy outlines data protection practices for your Tanzania travel bookings."
        keywords="privacy policy, data protection, personal information, travel data security"
        url="/privacy"
      />
      <Navbar />
