...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Page Not Found - Infinity Voyage Tours"
        description="The page you're looking for doesn't exist. Explore our Tanzania safaris and Zanzibar tours instead."
        url="/404"
      />
      <Navbar />
