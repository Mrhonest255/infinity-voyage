...
const Gallery = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO 
        title="Photo Gallery - Tanzania Safari & Zanzibar Pictures"
        description="Browse stunning photos from our Tanzania safari tours and Zanzibar excursions. See wildlife encounters, beautiful beaches, and unforgettable adventure moments."
        keywords="safari gallery, Tanzania photos, Zanzibar pictures, wildlife photography, Africa travel images"
        url="/gallery"
      />
      <Navbar />
