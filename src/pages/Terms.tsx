...
Address: Arusha, Tanzania`
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO 
        title="Terms of Service - Infinity Voyage Tours & Safaris"
        description="Read our terms of service including booking conditions, cancellation policy, payment terms, and liability information for your Tanzania safari and Zanzibar tours."
        keywords="terms of service, booking conditions, cancellation policy, safari terms, travel terms Tanzania"
        url="/terms"
      />
      <Navbar />
