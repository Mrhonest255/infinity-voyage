...
const ThankYou = () => {
  ...
  const steps = [
    { icon: CheckCircle2, title: "Booking Received", description: "We've received your request", completed: true },
    { icon: Clock, title: "Processing", description: "Our team is reviewing", completed: false },
    { icon: Calendar, title: "Confirmation", description: "We'll confirm your dates", completed: false },
    { icon: Heart, title: "Ready to Go!", description: "Your adventure awaits", completed: false },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Booking Confirmed - Thank You! | Infinity Voyage Tours"
        description="Your Tanzania safari or Zanzibar tour booking has been confirmed. Check your email for details and tracking information."
        url="/thank-you"
      />
      <Navbar />
