...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Travel Blog - Tanzania Safari & Zanzibar Travel Tips"
        description="Read travel tips, safari guides, and insider advice for your Tanzania adventure. Expert insights on wildlife viewing, best travel times, and hidden gems."
        keywords="Tanzania travel blog, safari tips, Zanzibar guide, Africa travel advice, wildlife viewing tips"
        url="/blog"
      />
      <Navbar />
                  ...
                  <Card className="h-full flex flex-col bg-white rounded-[2rem] overflow-hidden border-border/40 hover:shadow-2xl transition-all duration-500 group">
                    ...
                    <CardContent className="p-8 flex-1 flex flex-col">
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-border/50 mt-auto">
                        ...
                        <Button 
                          variant="ghost" 
                          className="text-safari-gold hover:text-safari-amber hover:bg-transparent p-0 font-bold group/btn"
                          onClick={() => alert('Full article coming soon! Stay tuned for more travel insights.')}
                        >
                          Read More
