...
export default function TrackBooking() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Track Your Booking - Infinity Voyage Tours"
        description="Track your safari or tour booking status with your unique tracking code. Get real-time updates on your Tanzania adventure booking."
        keywords="track booking, booking status, safari booking tracker, tour booking check"
        url="/track-booking"
      />
      <Navbar />
