    ...
    <section className="section-padding bg-gradient-to-b from-background via-muted/30 to-background relative overflow-hidden">
      ...
      <div className="container-wide mx-auto relative">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-card rounded-3xl p-8 md:p-12 shadow-luxury border border-border/30 relative overflow-hidden"
              >
                {/* Large Quote decoration */}
                <div className="absolute top-6 right-8 opacity-5">
                  <Quote className="w-32 h-32 text-safari-gold" strokeWidth={1} />
                </div>

                <div className="grid md:grid-cols-[auto,1fr] gap-8 md:gap-12 items-center relative z-10">
                  {/* Avatar Section */}
                  <div className="flex flex-col items-center md:items-start">
                    <div className="relative mb-4">
                      <div className="w-28 h-28 md:w-36 md:h-36 rounded-full overflow-hidden ring-4 ring-safari-gold/30 shadow-gold">
                        <img
                      ...
                      {/* Gold accent circle */}
                      <div className="absolute -bottom-2 -right-2 w-10 h-10 rounded-full bg-gradient-to-r from-safari-gold to-safari-amber flex items-center justify-center shadow-gold">
                    ...
                    <div className="flex gap-1 mb-3">
                      {[...Array(currentTestimonial.rating)].map((_, i) => (
                        <Star
                          key={i}
                          className="w-5 h-5 fill-safari-gold text-safari-gold"
                        />
                      ))}
                    </div>
                    
                    {/* Tour type badge */}
                    <span className="px-4 py-1.5 bg-safari-gold/10 text-safari-gold text-xs font-semibold rounded-full">
                  ...
                  {/* Content Section */}
                  <div>
                    <blockquote className="text-xl md:text-2xl text-foreground leading-relaxed mb-8" style={{ fontFamily: "'Inter', sans-serif" }}>
                      "{currentTestimonial.text}"
                    </blockquote>

                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="text-xl font-semibold text-foreground" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between pointer-events-none px-4 md:-mx-6">
              <Button
                ...
                size="icon"
                onClick={prevSlide}
                className="pointer-events-auto w-12 h-12 rounded-full bg-background/90 backdrop-blur-sm border-2 border-border hover:border-safari-gold hover:bg-safari-gold/10 shadow-soft transition-all duration-300"
              >
