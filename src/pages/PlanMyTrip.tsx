...
Additional Notes: ${formData.additionalInfo || 'None'}
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Plan My Trip - Custom Tanzania Safari & Zanzibar Tour"
        description="Create your personalized Tanzania safari or Zanzibar tour. Share your preferences and let our experts craft your perfect African adventure."
        keywords="custom safari, personalized tour, plan Tanzania trip, tailor-made safari, bespoke travel"
        url="/plan-my-trip"
      />
      <Navbar />
